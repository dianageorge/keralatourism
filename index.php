       ...
       <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img src="num1.jpg"   width ="50 px" height ="500 px" class="d-block w-100" alt="...">
          </div>
          <div class="carousel-item">
            <img src="num2.jpg" width ="50 px" height ="500 px"  class="d-block w-100" alt="...">
          </div>
          <div class="carousel-item">
            <img src="num3.jpg"  width ="50 px" height ="500 px"  class="d-block w-100" alt="...">
          </div>
        </div>
